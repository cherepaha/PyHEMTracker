...
class HEMTracker:
    ...
    def run_trial(self, session_number, block_number, trial_number, 
                  is_practice=False, coherence=0.512):
        ...
        stim_viewing_log = []
        self.user_interface.show_rdk_EAS(direction = random.choice(self.rdk_directions),
                                     coherence = coherence,
        ...
        self.user_interface.show_feedback_screen(response) 
